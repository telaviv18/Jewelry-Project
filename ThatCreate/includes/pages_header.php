                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li>
                                    <a class="dropdown-item" href="/pages/products.php?category=<?php echo $category['id']; ?>">
                                ...
                                <li>
                                    <a class="dropdown-item" href="/pages/products.php">All Products</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/pages/products.php">Shop</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <?php if ($current_user): ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userDropdown">
                                    <li><a class="dropdown-item" href="/pages/account.php">My Account</a></li>
                        ...
                        <?php else: ?>
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="loginDropdown">
                                    <li><a class="dropdown-item" href="/pages/login.php">Customer Login</a></li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="/pages/vendor_register.php">Become a Vendor</a>
                            </li>
                        <?php endif; ?>
                    </ul>
                </div>
